...
int main() {
    ...
    string arr[10];
    string arr2[10];
    cout << readBooks("./Input Files/books.txt", arr, arr2, 0, 10 ) << endl;
    ...
    string arr3[10];
    string arr4[10];
    cout << readBooks("./ThisFolderDoesn'tExistLOL/books.txt", arr3, arr4, 0, 10 ) << endl;
    ...
    string arr5[10];
    string arr6[10];
    cout << readBooks("./ThisFolderDoesn'tExistLOL/books.txt", arr5, arr6, 11, 10 ) << endl;
